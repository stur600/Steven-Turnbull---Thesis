...
\input{Abstract/abstract.tex} % it's in a separate file
...
\input{C1 - Introduction/C1 - text.tex}
\input{C2 - Student Pathways/C2 - text.tex}
\input{C3 - Bourdieu Networks/C3 - text.tex} 
\input{C4 - Science Capital Self-Concept/C4 - text.tex} 
\input{C5 - Understanding Capital Accumulation/C5 - text.tex}
\input{C6 - Experiences of Science Capital/C6 - text.tex}
\input{C7 - Opportunities For Intervention/C7 - text.tex}
...
\input{Appendices/A1 - ParticipantInformation.tex} 

%\printbibliography[title={Works cited}, heading=bibintoc]
\bibliography{bibfile_scicap_exp.bib}
